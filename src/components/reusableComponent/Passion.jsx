    ...
    <div>
      <div className=" lg:flex xl:flex mt-16 h-[880px] sm:h-[1000px] lg:h-[600px]">
        ...
        <div className="mb-[96px] sm:mb-0 ">
          ...
          /> */}
          <h2 className="text-[#0F1320] f font-bold text-[50px] pt-16 md:pt-8 leading-[70px] md:leading-[80px] md:text-[60px] xl:text-[80px] lg:leading-[100px] relative w-[90%] mx-auto lg:pt-16 sm:w-[50%] sm:mx-0 sm:ml-[5%] sm:pb-16 lg:ml-[10%] xl:w-[50%]  md:w-[65%] md:ml-[20%] md:mb-[20%]  lg:w-[80%] ">
            Passionate, Empathy,{" "}
