    ...
    <div>
      <div className=" lg:flex xl:flex mt-16 h-[880px] sm:h-[1000px] lg:h-[600px]">
        ...
        <div className="mb-[96px] sm:mb-0 ">
          ...
          /> */}
          <h2 className="text-[#0F1320] f font-bold text-[48px] leading-[60px] relative w-[90%] mx-auto pt-16 sm:w-[50%] sm:mx-0 sm:ml-[5%] sm:pb-16 xl:ml-[10%] xl:w-[50%] xl:pt-[20%] md:w-[70%] md:ml-[10%] md:mb-[20%] md:pt-[20%] lg:w-[80%] ">
            Passionate, Empathy,{" "}
